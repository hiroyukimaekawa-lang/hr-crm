...
const ensureKpiTable = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!kpiTablePromise) {
        kpiTablePromise = (() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            catch ( /* constraint may already exist */_a) { /* constraint may already exist */ }
            // Indexes
            try {
...
const getCanonicalFunnelCounts = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (groupByCol) {
        return Object.assign({ applications: 0, reservations: 0, interview_scheduled: 0, interview_completed: 0 }, (filters.groupBy === 'staff'
...
const upsertGoals = (goals) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const g of goals) {
        ...
        `, [
            ...
            g.scope_type || 'global',
            (_a = g.scope_id) !== null && _a !== void 0 ? _a : null,
        ...
        if (updateResult.rowCount === 0) {
            ...
            `, [
                g.scope_type || 'global',
                (_b = g.scope_id) !== null && _b !== void 0 ? _b : null,
                g.source_company || null,
                g.period_type || 'monthly',
                g.period_start,
                g.period_end || null,
...
const getEventKpiData = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const row of slotStatusRes.rows) {
        if (!slotBreakdownMap[row.event_id])
            slotBreakdownMap[row.event_id] = {};
        if (!slotBreakdownMap[row.event_id][row.slot_date])
            slotBreakdownMap[row.event_id][row.slot_date] = {};
    ...
    return eventsRes.rows.map((e) => {
        ...
        const normalize = (dt) => dt ? dt.slice(0, 16) : dt;
        const normalizedSlotBreakdown = {};
        ...
        try {
            ...
            if (Array.isArray(raw)) {
                customSteps = raw.filter((x) => x === null || x === void 0 ? void 0 : x.label);
            }
        }
        catch (_b) {
            customSteps = [];
...
const getSalesActuals = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
    const result = yield db_1.default.query(sql, params);
    const totalSales = result.rows.reduce((sum, r) => sum + Number(r.sales || 0), 0);
    const totalAttendance = result.rows.reduce((sum, r) => sum + Number(r.attended_count || 0), 0);
    return {
        events: result.rows,
        totalSales,
        totalAttendance
