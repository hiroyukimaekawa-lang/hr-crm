...
const getEvents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        `);
        const events = result.rows.map(r => (Object.assign(Object.assign({}, r), { source: 'event' })));
        res.json(events);
    }
    catch (err) {
...
const getEventDetail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        `, [id]);
        res.json({
            event: Object.assign(Object.assign({}, eventRes.rows[0]), { source: 'event', event_dates: eventDatesRes.rows.map((r) => r.event_date) }),
