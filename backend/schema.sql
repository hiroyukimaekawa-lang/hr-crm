...
-- Projects (v2: Event / Agent Interview Hybrid)
CREATE TABLE IF NOT EXISTS projects (
    id SERIAL PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    type VARCHAR(50) NOT NULL DEFAULT 'event', -- 'event' or 'agent_interview'
    description TEXT,
    graduation_year INTEGER,
    
    -- Legacy KPI / Event fields preserved for compatibility
    entry_deadline TIMESTAMP,
    kpi_seat_to_entry_rate NUMERIC(5,2) DEFAULT 70,
    kpi_entry_to_interview_rate NUMERIC(5,2) DEFAULT 60,
